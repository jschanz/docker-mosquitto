...
RUN mkdir /etc/mosquitto && chown mosquitto -R /etc/mosquitto
RUN mkdir /var/log/mosquitto && chown mosquitto -R /var/log/mosquitto
RUN mkdir /var/lib/mosquitto && chown mosquitto -R /var/lib/mosquitto
